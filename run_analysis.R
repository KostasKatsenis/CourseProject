...
NewTotalData<-dplyr::rename(NewTotalData,MeanOfBodyAcceleration_X_Axis=tBodyAcc.mean...X ,
   ...
   FFT_MeanOfBodyAcceleration_X_Axis=fBodyAcc.mean...X ,
   FFT_MeanOfBodyAcceleration_Y_Axis=fBodyAcc.mean...Y ,
   FFT_MeanOfBodyAcceleration_Z_Axis=fBodyAcc.mean...Z ,
   FFT_StandardDeviationOfBodyAcceleration_X_Axis=fBodyAcc.std...X ,
   FFT_StandardDeviationOfBodyAcceleration_Y_Axis=fBodyAcc.std...Y ,
   FFT_StandardDeviationOfBodyAcceleration_Z_Axis=fBodyAcc.std...Z ,
   FFT_MeanOfJerkOfBodyAcceleration_X_Axis=fBodyAccJerk.mean...X ,
   FFT_MeanOfJerkOfBodyAcceleration_Y_Axis=fBodyAccJerk.mean...Y ,
   FFT_MeanOfJerkOfBodyAcceleration_Z_Axis=fBodyAccJerk.mean...Z ,
   FFT_StandardDeviationOfJerkOfBodyAcceleration_X_Axis=fBodyAccJerk.std...X ,
   FFT_StandardDeviationOfJerkOfBodyAcceleration_Y_Axis=fBodyAccJerk.std...Y ,
   FFT_StandardDeviationOfJerkOfBodyAcceleration_Z_Axis=fBodyAccJerk.std...Z ,
   FFT_MeanOfAngularVelocity_X_Axis=fBodyGyro.mean...X ,
   FFT_MeanOfAngularVelocity_Y_Axis=fBodyGyro.mean...Y ,
   FFT_MeanOfAngularVelocity_Z_Axis=fBodyGyro.mean...Z ,
   FFT_StandardDeviationOfAngularVelocity_X_Axis=fBodyGyro.std...X ,
   FFT_StandardDeviationOfAngularVelocity_Y_Axis=fBodyGyro.std...Y ,
   FFT_StandardDeviationOfAngularVelocity_Z_Axis=fBodyGyro.std...Z ,
   FFT_MeanOfMagnitudeOfBodyAcceleration=fBodyAccMag.mean.. ,
   FFT_StandardDeviationOfMagnitudeOfBodyAcceleration=fBodyAccMag.std.. ,
   FFT_MeanOfMagnitudeOfJerkOfBodyAcceleration=fBodyBodyAccJerkMag.mean.. ,
   FFT_StandardDeviationOfMagnitudeOfJerkOfBodyAcceleration=fBodyBodyAccJerkMag.std.. ,
   FFT_MeanOfMagnitudeOfAngularVelocity=fBodyBodyGyroMag.mean.. ,
   FFT_StandardDeviationOfMagnitudeOfAngularVelocity=fBodyBodyGyroMag.std.. ,
   FFT_MeanOfMagnitudeOfAngularJerk=fBodyBodyGyroJerkMag.mean.. ,
   FFT_StandardDeviationOfMagnitudeOfAngularJerk=fBodyBodyGyroJerkMag.std..) 
...
FinalData<-plyr::ddply(NewTotalData,.(Volunteer_No,Activity),summarize,
  ...
  MeanFFT_MeanOfBodyAcceleration_X_Axis=mean(FFT_MeanOfBodyAcceleration_X_Axis),
  MeanFFT_MeanOfBodyAcceleration_Y_Axis=mean(FFT_MeanOfBodyAcceleration_Y_Axis),
  MeanFFT_MeanOfBodyAcceleration_Z_Axis=mean(FFT_MeanOfBodyAcceleration_Z_Axis),
  MeanFFT_StandardDeviationOfBodyAcceleration_X_Axis=mean(FFT_StandardDeviationOfBodyAcceleration_X_Axis),
  MeanFFT_StandardDeviationOfBodyAcceleration_Y_Axis=mean(FFT_StandardDeviationOfBodyAcceleration_Y_Axis),
  MeanFFT_StandardDeviationOfBodyAcceleration_Z_Axis=mean(FFT_StandardDeviationOfBodyAcceleration_Z_Axis),          
  MeanFFT_MeanOfJerkOfBodyAcceleration_X_Axis=mean(FFT_MeanOfJerkOfBodyAcceleration_X_Axis), 
  MeanFFT_MeanOfJerkOfBodyAcceleration_Y_Axis=mean(FFT_MeanOfJerkOfBodyAcceleration_Y_Axis),
  MeanFFT_MeanOfJerkOfBodyAcceleration_Z_Axis=mean(FFT_MeanOfJerkOfBodyAcceleration_Z_Axis),
  MeanFFT_StandardDeviationOfJerkOfBodyAcceleration_X_Axis=mean(FFT_StandardDeviationOfJerkOfBodyAcceleration_X_Axis),
  MeanFFT_StandardDeviationOfJerkOfBodyAcceleration_Y_Axis=mean(FFT_StandardDeviationOfJerkOfBodyAcceleration_Y_Axis),
  MeanFFT_StandardDeviationOfJerkOfBodyAcceleration_Z_Axis=mean(FFT_StandardDeviationOfJerkOfBodyAcceleration_Z_Axis),
  MeanFFT_MeanOfAngularVelocity_X_Axis=mean(FFT_MeanOfAngularVelocity_X_Axis),
  MeanFFT_MeanOfAngularVelocity_Y_Axis=mean(FFT_MeanOfAngularVelocity_Y_Axis),
  MeanFFT_MeanOfAngularVelocity_Z_Axis=mean(FFT_MeanOfAngularVelocity_Z_Axis),
  MeanFFT_StandardDeviationOfAngularVelocity_X_Axis=mean(FFT_StandardDeviationOfAngularVelocity_X_Axis),
  MeanFFT_StandardDeviationOfAngularVelocity_Y_Axis=mean(FFT_StandardDeviationOfAngularVelocity_Y_Axis),
  MeanFFT_StandardDeviationOfAngularVelocity_Z_Axis=mean(FFT_StandardDeviationOfAngularVelocity_Z_Axis),
  MeanFFT_MeanOfMagnitudeOfBodyAcceleration=mean(FFT_MeanOfMagnitudeOfBodyAcceleration),
  MeanFFT_StandardDeviationOfMagnitudeOfBodyAcceleration=mean(FFT_StandardDeviationOfMagnitudeOfBodyAcceleration),      
  MeanFFT_MeanOfMagnitudeOfJerkOfBodyAcceleration=mean(FFT_MeanOfMagnitudeOfJerkOfBodyAcceleration),
  MeanFFT_StandardDeviationOfMagnitudeOfJerkOfBodyAcceleration=mean(FFT_StandardDeviationOfMagnitudeOfJerkOfBodyAcceleration),
  MeanFFT_MeanOfMagnitudeOfAngularVelocity=mean(FFT_MeanOfMagnitudeOfAngularVelocity),
  MeanFFT_StandardDeviationOfMagnitudeOfAngularVelocity=mean(FFT_StandardDeviationOfMagnitudeOfAngularVelocity),
  MeanFFT_MeanOfMagnitudeOfAngularJerk=mean(FFT_MeanOfMagnitudeOfAngularJerk),
  MeanFFT_StandardDeviationOfMagnitudeOfAngularJerk=mean(FFT_StandardDeviationOfMagnitudeOfAngularJerk))
